                        ...
                        <form action="<?php echo e(route('admin.homeone.service.area')); ?>" method="post"
                            ...
                            <div class="form-group">
                                ...
                                <div class="media-upload-btn-wrapper">
                                    ...
                                    <button type="button" class="btn btn-info media_upload_form_btn" data-btntitle="Select Service Background Image" data-modaltitle="Upload Service Background Image" data-imgid="<?php echo e(get_static_option('home_page_01_service_area_background_image')); ?>" data-toggle="modal" data-target="#media_upload_modal">
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xgenxchi/public_html/laravel/dizzcox/@core/resources/views/backend/pages/home/home-01/service-area.blade.php ENDPATH**/ ?>