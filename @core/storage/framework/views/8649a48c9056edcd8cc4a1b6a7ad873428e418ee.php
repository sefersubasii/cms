                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('admin.knowledge.page.settings')); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <small><?php echo e(__('Select Category To Show category in Knowledgebase page')); ?></small>
                            <br>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/sharifur/Desktop/sharifur-backup/localhost/dizzcox/@core/resources/views/backend/knowledgebase/knowledgebase-page-settings.blade.php ENDPATH**/ ?>