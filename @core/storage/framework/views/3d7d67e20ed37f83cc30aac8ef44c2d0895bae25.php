...
<?php $__env->startSection('breadcrumb'); ?>
    ...
    <li><?php echo e(get_static_option('events_page_'.$user_select_lang_slug.'_name').' '.__('Attendance Confirm')); ?></li>
<?php $__env->stopSection(); ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php if(!check_currency_support_by_payment_gateway($payment_gateway)): ?>
                                            <br>
                                            <small><?php echo e(__('You will charge in '.get_charge_currency($payment_gateway).', you have to pay'. ' ')); ?> <strong><?php echo e(get_charge_amount($attendance_details->event_cost * $attendance_details->quantity,$payment_gateway).get_charge_currency($payment_gateway)); ?></strong></small>
                                        <?php endif; ?>
                                    </td>
                                </tr>
                                <tr>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/sharifur/Desktop/sharifur-backup/localhost/dizzcox/@core/resources/views/frontend/payment/booking-confirm.blade.php ENDPATH**/ ?>