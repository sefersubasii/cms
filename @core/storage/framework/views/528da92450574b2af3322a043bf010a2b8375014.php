                                        ...
                                        <table id="all_user_table" class="text-center">
                                            ...
                                            <?php $__currentLoopData = $all_user; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo e($data->email); ?> <?php if($data->email_verified > 0): ?> <i class="fas fa-check-circle"></i><?php endif; ?></td>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/sharifur/Desktop/sharifur-backup/localhost/dizzcox/@core/resources/views/backend/frontend-user/all-user.blade.php ENDPATH**/ ?>