                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if($data->icon_type == 'icon'): ?>
                                                        <i class="<?php echo e($data->icon); ?>" style="font-size: 40px;"></i>
                                                    <?php else: ?>
                                                ...
                                                <td>
                                                    <a tabindex="0" class="btn btn-lg btn-danger btn-sm mb-3 mr-1"
                                                       ...
                                                       <form method='post' action='<?php echo e(route('admin.gigs.category.delete',$data->id)); ?>'>
            ...
            <div class="col-lg-6 mt-5">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('admin.gigs.category')); ?>" method="post" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
    ...
    <div class="modal fade" id="category_edit_modal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="<?php echo e(route('admin.gigs.category.update')); ?>"  method="post">
        ...
        $(document).ready(function () {
            ...
            $(document).on('click','#bulk_delete_btn',function (e) {
                ...
                if(allIds != ''){
                    ...
                    $.ajax({
                        'type' : "POST",
                        'url' : "<?php echo e(route('admin.gigs.category.bulk.action')); ?>",
                        'data' : {
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/sharifur/Desktop/sharifur-backup/localhost/dizzcox/@core/resources/views/backend/gigs/gigs-category.blade.php ENDPATH**/ ?>