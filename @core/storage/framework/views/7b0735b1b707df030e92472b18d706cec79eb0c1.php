    ...
    <div class="col-lg-12 col-ml-12 padding-bottom-30">
        <div class="row">
            ...
            <div class="col-lg-12 mt-5">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title"><?php echo e(__('All Gigs')); ?></h4>
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <?php $a=0; ?>
                            <?php $__currentLoopData = $all_gigs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $job): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="nav-item">
                                        ...
                                        <table class="table table-default" id="all_blog_table">
                                            ...
                                            <?php $__currentLoopData = $job; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo e(get_gigs_category_by_id($data->category_id)); ?></td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <a tabindex="0" class="btn btn-danger btn-xs mb-3 mr-1"
                                                           ...
                                                           title=""
                                                           data-content="
                                                           <h6><?php echo e(__('Are you sure to delete this gig?')); ?></h6>
                                                           <form method='post' action='<?php echo e(route('admin.gigs.delete',$data->id)); ?>'>
                                                        ...
                                                        <a class="btn btn-xs btn-primary mb-3 mr-1" href="<?php echo e(route('admin.gigs.edit',$data->id)); ?>">
                                                            <i class="ti-pencil"></i>
                                                        </a>
                                                        <a class="btn btn-xs btn-light mb-3 mr-1" target="_blank" href="<?php echo e(route('frontend.gigs.single',$data->slug)); ?>">
                                                            <i class="ti-eye"></i>
                                                        </a>
                                                        <form action="<?php echo e(route('admin.gigs.clone')); ?>" method="post" style="display: inline-block">
                                                            <?php echo csrf_field(); ?>
        ...
        $(document).ready(function() {
            $(document).on('click','#bulk_delete_btn',function (e) {
                ...
                if(allIds != ''){
                    ...
                    $.ajax({
                        'type' : "POST",
                        'url' : "<?php echo e(route('admin.gigs.bulk.action')); ?>",
                        'data' : {
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/sharifur/Desktop/sharifur-backup/localhost/dizzcox/@core/resources/views/backend/gigs/all-gigs.blade.php ENDPATH**/ ?>