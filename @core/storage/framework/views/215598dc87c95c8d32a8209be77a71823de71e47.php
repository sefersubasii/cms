                    ...
                    <div class="card-body">
                        <div class="gig-chat-message-heading">
                            <div class="header-wrap">
                                <h4 class="header-title"><?php echo e(__('Gig order message')); ?></h4>
                                <a class="btn btn-primary btn-xs" href="<?php echo e(route('admin.gigs.orders')); ?>"><?php echo e(__('All Gig Orders')); ?></a>
                            </div>
                            <div class="gig-order-info">
                                <ul>
                                    ...
                                    <li><strong><?php echo e(__('Order Status:')); ?></strong> <?php echo e(ucwords(str_replace('_',' ',$gig_details->order_status))); ?></li>
                            ...
                            <div class="reply-message-wrap ">
                                ...
                                <?php endif; ?>
                                <form action="<?php echo e(route('admin.gigs.orders.message.store')); ?>" method="post" enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/sharifur/Desktop/sharifur-backup/localhost/dizzcox/@core/resources/views/backend/gigs/gig-order-message.blade.php ENDPATH**/ ?>