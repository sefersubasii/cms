...
<body>
    <div class="mail-container">
        ...
        <div class="description">
            ...
            <p><?php echo e(__('Your')); ?> #<?php echo e($data->id); ?></p>
        </div>
        <div class="brief-wrapper">
        ...
        <table>
           <thead>
            ...
            <tbody>
            <?php $cart_items = unserialize($data->cart_items,['class' => false]); ?>
                    ...
                    <td>
                        <div class="product-info-wrap">
                            ...
                            <?php if(get_static_option('product_tax_type') == 'individual' && is_tax_enable()): ?>
                                ...
                                ?>
                            <span class="pdetails" style="color: red"><strong><?php echo e(__('Tax')); ?> <?php echo e(__('('.$percentage.'%) :')); ?></strong> +<?php echo e(amount_with_currency_symbol($tax_amount)); ?></span>
                            <?php endif; ?>
...
<?php /**PATH D:\laragon\www\dizzcox-update\@core\resources\views/mail/product-order.blade.php ENDPATH**/ ?>