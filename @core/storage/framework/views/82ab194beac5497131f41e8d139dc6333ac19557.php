                            ...
                            <div class="tab-content margin-top-30" id="nav-tabContent">
                                <?php $__currentLoopData = $all_languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="tab-pane fade <?php if($key == 0): ?> show active <?php endif; ?>" id="nav-home-<?php echo e($lang->slug); ?>" role="tabpanel" aria-labelledby="nav-home-tab">
                                        ...
                                        <div class="form-group">
                                            <label for="donation_single_<?php echo e($lang->slug); ?>_recently_donated_title"><?php echo e(__('Recently Donated Title')); ?></label>
                                            <input type="text" name="donation_single_<?php echo e($lang->slug); ?>_recently_donated_title"  class="form-control" value="<?php echo e(get_static_option('donation_single_'.$lang->slug.'_recently_donated_title')); ?>">
                                        </div>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\dizzcox-update\@core\resources\views/backend/donations/donation-single-page-settings.blade.php ENDPATH**/ ?>