                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('admin.products.category.new')); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <small><?php echo e(__('300x300 px image recommended')); ?></small>
                            </div>
                            <div class="form-group">
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/sharifur/Desktop/sharifur-backup/localhost/dizzcox/@core/resources/views/backend/products/all-products-category.blade.php ENDPATH**/ ?>