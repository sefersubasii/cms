                ...
                <div class="card">
                    <div class="card-body">
                        <div class="header-wrap">
                            ...
                            <a href="<?php echo e(route('admin.donations.all')); ?>" class="btn btn-info btn-xs"><i class="fas fa-angle-double-left"></i><?php echo e(__('All Donation Posts')); ?></a>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="meta_title"  class="form-control" value="<?php echo e($donation->meta_title); ?>" >
                                    </div>
                                    <div class="form-group">
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/sharifur/Desktop/sharifur-backup/localhost/dizzcox/@core/resources/views/backend/donations/edit-donations.blade.php ENDPATH**/ ?>