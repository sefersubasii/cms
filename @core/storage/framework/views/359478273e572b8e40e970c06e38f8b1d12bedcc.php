    ...
    <script>
        (function ($) {
            ...
            $(document).on('click','.checkout_form_submit_btn',function (e) {
                ...
                $('input[name="transaction_id_val"]').val(manual_payment_gateway_transaction_id);
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/sharifur/Desktop/sharifur-backup/localhost/dizzcox/@core/resources/views/frontend/pages/products/product-checkout.blade.php ENDPATH**/ ?>