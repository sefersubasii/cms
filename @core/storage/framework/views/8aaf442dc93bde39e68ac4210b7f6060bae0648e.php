                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="site_default_payment_gateway" class="form-control" >
                                            <?php
                                                $all_gateways = ['paypal','manual_payment','mollie','paytm','stripe','razorpay','flutterwave','paystack','midtrans','payfast','cashfree','instamojo','marcadopago'];
                                            ?>
                                    ...
                                    <div class="accordion-wrapper">
                                        <div id="accordion-payment">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="paypal_mode"
                                                                   class="form-control"
                                                                   value="<?php echo e(get_static_option('paypal_mode')); ?>">
                                                        </div>
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="paypal_currency"><?php echo e(__('Paypal Currency')); ?></label>
                                                            <select name="paypal_currency" class="form-control"
                                                                    id="paypal_currency">
                                                                <?php $__currentLoopData = script_currency_list(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cur => $symbol): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <option value="<?php echo e($cur); ?>"
                                                                            <?php if(get_static_option('paypal_currency') == $cur): ?> selected <?php endif; ?>><?php echo e($cur.' ( '.$symbol.' )'); ?></option>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                            </select>
                                                        </div>

                                                        <div class="form-group">
                                                            <label for="paypal_notify_url"><?php echo e(__('Paypal Notify URL')); ?></label>
                                                            <input type="text" name="paypal_notify_url"
                                                                   class="form-control"
                                                                   value="<?php echo e(get_static_option('paypal_notify_url')); ?>">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="paypal_locale"><?php echo e(__('Paypal Locale')); ?></label>
                                                            <input type="text" name="paypal_locale"
                                                                   class="form-control"
                                                                   value="<?php echo e(get_static_option('paypal_locale')); ?>">
                                                        </div>

                                                        <div class="form-group">
                                                            <label for="paypal_validate_ssl"><?php echo e(__('Paypal Validate SSL')); ?></label>
                                                            <input type="text" name="paypal_validate_ssl"
                                                                   class="form-control"
                                                                   value="<?php echo e(get_static_option('paypal_validate_ssl')); ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="midtrans_settings_content" class="collapse"  data-parent="#midtrans-payment">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="midtrans_environment"><?php echo e(__('Midtranse Environment')); ?></label>
                                                            <input type="text" name="midtrans_environment" id="midtrans_environment" value="<?php echo e(get_static_option('midtrans_environment')); ?>" class="form-control">
                                                        </div>
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="payfast_settings_content" class="collapse"  data-parent="#payfast-payment">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="midtrans_environment"><?php echo e(__('Payfast Merchant ENV')); ?></label>
                                                            <input type="text" name="payfast_merchant_env" id="payfast_merchant_env" value="<?php echo e(get_static_option('payfast_merchant_env')); ?>" class="form-control">
                                                        </div>
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="cashfree_settings_content" class="collapse"  data-parent="#cashfree-payment">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="cashfree_test_mode"><?php echo e(__('Cashfree Test Mode')); ?></label>
                                                            <input type="text" name="cashfree_test_mode" id="cashfree_test_mode" value="<?php echo e(get_static_option('cashfree_test_mode')); ?>" class="form-control">
                                                        </div>
                                                        <div class="form-group">
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="instamojo_settings_content" class="collapse"  data-parent="#instamojo-payment">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="instamojo_test_mode"><?php echo e(__('Instamojo Test Mode')); ?></label>
                                                            <input type="text" name="instamojo_test_mode" id="instamojo_test_mode" value="<?php echo e(get_static_option('instamojo_test_mode')); ?>" class="form-control">
                                                        </div>
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="marcado_pago_settings_content" class="collapse"  data-parent="#marcadopago-payment">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="marcadopago_test_mode"><strong><?php echo e(__('Enable Test Mode Instamojo')); ?></strong></label>
                                                            <label class="switch">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="marcadopago_preview_logo"><strong><?php echo e(__('Marcado Pago_gateway Logo')); ?></strong></label>
                                                            <div class="media-upload-btn-wrapper">
                                                                <div class="img-wrap">
                                                                    <?php
                                                        ...
                                                        <div class="form-group">
                                                            <label for="marcado_pago_test_mode"><?php echo e(__('Marcado Pago Test Mode')); ?></label>
                                                            <input type="text" name="marcado_pago_test_mode" id="marcado_pago_test_mode" value="<?php echo e(get_static_option('marcado_pago_test_mode')); ?>" class="form-control">
                                                        </div>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xgenxchi/public_html/laravel/dizzcox/@core/resources/views/backend/general-settings/payment-gateway.blade.php ENDPATH**/ ?>