...
<body>
    <div class="mail-container">
        ...
        <div class="description">
            ...
            <p><?php echo e(__('Order #'.$data->id)); ?></p>
        </div>
        <div class="brief-wrapper">
           <p> <?php echo e(__('Hey')); ?> <?php echo e($data->billing_name); ?></p>
            <p><?php echo e(__('Your order #'.$data->id)); ?> <?php echo e(__('has been placed on '.date_format($data->created_at,'d F Y H:m:s'))); ?> <?php echo e(__('via '.ucwords(str_replace('_',' ',$data->payment_gateway)).'. You will be updated with another email after your item(s) has been shipped.')); ?></p>
        </div>
        <?php else: ?>
        <div class="description">
        ...
        <div class="brief-wrapper">
            ...
            <p><?php echo e(__('Your have an order #'.$data->id)); ?> <?php echo e(' '.$data->billing_name); ?><?php echo e(__(' has been placed it on '.date_format($data->created_at,'d F Y H:m:s'))); ?> <?php echo e(__('via '.ucwords(str_replace('_',' ',$data->payment_gateway)).'.')); ?></p>
        </div>
        <?php endif; ?>
...
<?php /**PATH /Users/sharifur/Desktop/sharifur-backup/localhost/dizzcox/@core/resources/views/mail/product-order.blade.php ENDPATH**/ ?>