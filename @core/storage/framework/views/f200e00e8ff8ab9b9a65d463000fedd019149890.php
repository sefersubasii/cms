                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('admin.new.user')); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <small><?php echo e(__('Recommended image size 100x100')); ?></small>
                            </div>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xgenxchi/public_html/laravel/dizzcox/@core/resources/views/backend/user-role-manage/add-new-user.blade.php ENDPATH**/ ?>