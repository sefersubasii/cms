...
<?php endif; ?> 
            ...
            <?php if(in_array(get_static_option('home_page_variant'),['01','05'])): ?>
            ...
            <?php endif; ?>
            <?php if(in_array(get_static_option('home_page_variant'),['01','02'])): ?>
            <div class="col-lg-6 mt-5">
                <div class="card">
                    <div class="card-body">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/sharifur/Desktop/sharifur-backup/localhost/dizzcox/@core/resources/views/backend/pages/top-bar.blade.php ENDPATH**/ ?>