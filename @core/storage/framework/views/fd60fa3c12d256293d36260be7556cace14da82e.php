            ...
            $(document).on('click','.view_order_details_btn',function (e) {
                ...
                if(allData.attachment){
                    $.each(allData.attachment,function (index,value) {
                        parent.find('.order-all-custom-fields tbody').append('<tr class="attachment_list"><td class="fname">'+index.replace('-',' ')+'</td><td class="fvalue"><a href="<?php echo e(url('/')); ?>'+'/'+value+'" download>'+value.substr(36)+'</a></td></tr>');
                    });
                }
            })
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\dizzcox-update\@core\resources\views/backend/jobs/all-applicant.blade.php ENDPATH**/ ?>