...
function about_us_widget($type = 'new', $id = null)
{
    ...
    $image_preview = '';
    $image_btn_label =  __('Logo');

    //social icon value
    $widget_fb_url = !empty($widget_saved_values) && isset($widget_saved_values['about_widget_title_facebook_url']) ? $widget_saved_values['about_widget_title_facebook_url'] : '';
    $widget_twitter_url = !empty($widget_saved_values) && isset($widget_saved_values['about_widget_title_twitter_url']) ? $widget_saved_values['about_widget_title_twitter_url'] : '';
    $widget_instagram_url = !empty($widget_saved_values) && isset($widget_saved_values['about_widget_title_instagram_url']) ? $widget_saved_values['about_widget_title_instagram_url'] : '';
    $widget_linkedin_url = !empty($widget_saved_values) && isset($widget_saved_values['about_widget_title_linkedin_url']) ? $widget_saved_values['about_widget_title_linkedin_url'] : '';
    $widget_youtube_url = !empty($widget_saved_values) && isset($widget_saved_values['about_widget_title_youtube_url']) ? $widget_saved_values['about_widget_title_youtube_url'] : '';
    $widget_dribbble_url = !empty($widget_saved_values) && isset($widget_saved_values['about_widget_title_dribbble_url']) ? $widget_saved_values['about_widget_title_dribbble_url'] : '';
    $widget_github_url = !empty($widget_saved_values) && isset($widget_saved_values['about_widget_title_github_url']) ? $widget_saved_values['about_widget_title_github_url'] : '';
    $widget_pinterest_url = !empty($widget_saved_values) && isset($widget_saved_values['about_widget_title_pinterest_url']) ? $widget_saved_values['about_widget_title_pinterest_url'] : '';
    ...
    if (!empty($widget_saved_values)) {
        ...
        $image_btn_label =  __('Update Logo');
    }
    ...
    $output .= $image_btn_label . '</button></div>';
    ...
    $output .= '<div class="form-group"><label>'.__('Facebook Url').'</label><input type="text" name="about_widget_title_facebook_url" class="form-control" placeholder="' . __('Facebook Url') . '" value="'. $widget_fb_url .'"></div>';
    $output .= '<div class="form-group"><label>'.__('Twitter Url').'</label><input type="text" name="about_widget_title_twitter_url" class="form-control" placeholder="' . __('Twitter Url') . '" value="'. $widget_twitter_url .'"></div>';
    $output .= '<div class="form-group"><label>'.__('Instagram Url').'</label><input type="text" name="about_widget_title_instagram_url" class="form-control" placeholder="' . __('Instagram Url') . '" value="'. $widget_instagram_url .'"></div>';
    $output .= '<div class="form-group"><label>'.__('Linkedin Url').'</label><input type="text" name="about_widget_title_linkedin_url" class="form-control" placeholder="' . __('Linkedin Url') . '" value="'. $widget_linkedin_url .'"></div>';
    $output .= '<div class="form-group"><label>'.__('Youtube Url').'</label><input type="text" name="about_widget_title_youtube_url" class="form-control" placeholder="' . __('Youtube Url') . '" value="'. $widget_youtube_url .'"></div>';
    $output .= '<div class="form-group"><label>'.__('Dribbble Url').'</label><input type="text" name="about_widget_title_dribbble_url" class="form-control" placeholder="' . __('Dribbble Url') . '" value="'. $widget_dribbble_url .'"></div>';
    $output .= '<div class="form-group"><label>'.__('Github Url').'</label><input type="text" name="about_widget_title_github_url" class="form-control" placeholder="' . __('Github Url') . '" value="'. $widget_github_url .'"></div>';
    $output .= '<div class="form-group"><label>'.__('Pinterest Url').'</label><input type="text" name="about_widget_title_pinterest_url" class="form-control" placeholder="' . __('Pinterest Url') . '" value="'. $widget_pinterest_url .'"></div>';
...
function render_about_us_widget($id)
{
    ...
    //social icon value
    $social_fields = [
        'about_widget_title_facebook_url' => 'fab fa-facebook-f',
        'about_widget_title_twitter_url' => 'fab fa-twitter',
        'about_widget_title_instagram_url' => 'fab fa-linkedin-in',
        'about_widget_title_linkedin_url' => 'fab fa-instagram',
        'about_widget_title_youtube_url' => 'fab fa-youtube',
        'about_widget_title_dribbble_url' => 'fab fa-dribbble',
        'about_widget_title_github_url' => 'fab fa-github',
        'about_widget_title_pinterest_url' => 'fab fa-pinterest-p',
    ];
    ...
    foreach ($social_fields as $key => $sc_field){
        if (!empty($widget_saved_values) && isset($widget_saved_values[$key])){
            $output .= '<li><a href="'.$widget_saved_values[$key].'"><i class="'.$sc_field.'"></i></a></li>';
        }
    }
    $output .= '</ul>';
    $output .= '</div></div></div>';
...
function recent_work_widget($type = 'new', $id = null){
    $output = '';
    $widget_data = !empty($id) ? Widgets::find($id) : '';
    $widget_order = !empty($widget_data) ? $widget_data->widget_order : '';
    $output .= get_widget_default_fields($type, 'recent_work_widget', 'render_recent_work_widget', 'Recent Work', $id, $widget_order);
 ...
 * it will be used for render content in frontend
 * */
function render_recent_work_widget($id){
    $widget_data = !empty($id) ? Widgets::find($id) : '';
    $widget_saved_values = !empty($widget_data) ? unserialize($widget_data->widget_content) : '';
    $widget_title = !empty($widget_saved_values) && isset($widget_saved_values['widget_title_'. get_user_lang()]) ? $widget_saved_values['widget_title_'. get_user_lang()] : '';
    $post_items = !empty($widget_saved_values) && isset($widget_saved_values['post_items']) ? $widget_saved_values['post_items'] : '';
