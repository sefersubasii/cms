...
class GeneralSettingsController extends Controller
{
    ...
    public function update_payment_settings(Request $request)
    {
        ...
        $env_val['MIDTRANS_ENVAIRONTMENT'] = $request->midtrans_environment  ? : 'false';
        ...
        $env_val['PF_MERCHANT_ENV'] = $request->payfast_merchant_env  ? : 'true';
        ...
        $env_val['INSTAMOJO_TEST_MODE'] =  $request->instamojo_test_mode ? : 'true';
        ...
        $env_val['MERCADO_PAGO_TEST_MOD'] = $request->marcado_pago_test_mode ? : 'true';
