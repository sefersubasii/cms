...
class LanguageController extends Controller
{
    ...
    public function delete(Request $request, $id)
    {
        ...
        Gig::where('lang', $lang->slug)->delete();
        GigsCategory::where('lang', $lang->slug)->delete();
        ImageGalleryCategory::where('lang', $lang->slug)->delete();
        ImageGallery::where('lang', $lang->slug)->delete();
