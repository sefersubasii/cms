...
@endsection
@section('breadcrumb')
    <li><a href="{{route('user.home')}}">{{__('User Dashboard')}}</a></li>
    <li> {{__('Gig order message')}}</li>
@endsection
@section('style')
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="gig-chat-message-wrap">
                        <a href="{{route('user.home')}}" class="anchor-btn margin-bottom-30">{{__('Back to dashboard')}}</a>
                        <div class="gig-chat-message-heading">
                            ...
                            <div class="gig-message-start-wrap">
                                ...
                                @if(!empty($gig_message))
                                    ...
                                    @foreach($gig_message as $msg)
                                        <div class="single-message-item @if($msg->user_type == 'admin') customer @endif">
                                            <div class="top-part">
                                                <div class="thumb">
                                                    <span class="title">
                            ...
                            <div class="reply-message-wrap ">
                                ...
                                @endif
                                <form action="{{route('user.home.gig.new.message')}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <button class="boxed-btn" type="submit">{{__('Send Message')}}</button>
                                </form>
                            </div>
                        </div>
                    </div>
