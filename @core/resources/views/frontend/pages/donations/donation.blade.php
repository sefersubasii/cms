                            ...
                            <div class="contribute-single-item donation-page grid-item margin-bottom-40">
                                ...
                                <div class="content">
                                    ...
                                    <div class="thumb-content">
                                        ...
                                        <div class="goal">
                                            <h4 class="raised">{{get_static_option('donation_raised_'.$user_select_lang_slug.'_text')}} @if(!empty($data->raised)){{site_currency_symbol()}}{{$data->raised}}@else {{site_currency_symbol()}}0 @endif</h4>
                                            <h4 class="raised">{{get_static_option('donation_goal_'.$user_select_lang_slug.'_text')}} {{site_currency_symbol()}}{{$data->amount}}</h4>
                                        </div>
                                    </div>
