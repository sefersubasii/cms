...
@endsection
@section('edit_link')
    <li><a href="{{route('admin.products.edit',$product->id)}}"><i class="far fa-edit"></i> {{__('Edit Product')}}</a></li>
@endsection
@section('breadcrumb')
    <li><a href="{{route('frontend.products.category',['id' => $product->category_id,'any' => Str::slug(get_product_category_by_id($product->category_id))])}}">{{get_product_category_by_id($product->category_id)}}</a></li>
    <li>{{$product->title}}</li>
@endsection
@section('content')
                            ...
                            <div class="extra-content-wrap">
                                <nav>
                                    <div class="nav nav-tabs" role="tablist">
                                        ...
                                        @endif
                                        @if(!empty($product->attributes_title))
                                                        ...
                                                        <form action="{{route('user.login')}}" method="post"
                                                            ...
                                                            <div class="row mb-4 rmber-area">
                                                                ...
                                                                <div class="col-6 text-right">
                                                                    <a class="d-block"
                                                                       href="{{route('user.register')}}">{{__('Haven\'t any account?')}}</a>
                                        ...
                                        <div class="col-lg-3">
                                            <div class="single-product-item-3 margin-bottom-30">
                                                ...
                                                <div class="content">
                                                    ...
                                                    <div class="price-wrap">
                                                        <span
                                                            class="price">{{site_currency_symbol().$data->sale_price}}</span>
                                                        @if(!empty($data->regular_price))
                                                            <del
                                                                class="del-price">{{site_currency_symbol().$data->regular_price}}</del>@endif
                                                    </div>
