...
@endsection
@section('breadcrumb')
    <li>{{get_static_option('product_page_'.$user_select_lang_slug.'_name')}}</li>
@endsection
@section('content')
                ...
                <div class="col-lg-3 order-lg-1">
                    <div class="product-widget-area">
                        ...
                        <div class="widget widget_price_filter">
                            ...
                            <button type="button" class="boxed-btn style-01" id="submit_price_filter_btn">{{__("Apply Filter")}}</button>
                        </div>
