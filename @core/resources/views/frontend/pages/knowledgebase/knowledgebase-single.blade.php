...
@section('site-title')
    {{$knowledgebase->meta_title ?? $knowledgebase->title}}
@endsection
@section('page-title')
    {{$knowledgebase->title}}
@endsection
@section('breadcrumb')
    @if(get_knowledgebase_topic($knowledgebase->topic_id) != 'uncategorized')
    <li><a href="{{route('frontend.knowledgebase.category',['id' => $knowledgebase->topic_id , 'any' => Str::slug(get_knowledgebase_topic($knowledgebase->topic_id))])}}">{{get_knowledgebase_topic($knowledgebase->topic_id)}}</a></li>
    @endif
    <li>{{$knowledgebase->title}}</li>
@endsection
@section('content')
