...
@endsection
@section('breadcrumb')
    <li> {{get_static_option('feedback_page_'.$user_select_lang_slug.'_name')}}</li>
@endsection
@section('content')
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="contact-info">
                        ...
                        <form action="{{route('frontend.clients.feedback.store')}}" method="post" class="feedback-page-form" enctype="multipart/form-data">
                            @csrf
