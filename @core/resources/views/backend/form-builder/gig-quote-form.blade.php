    ...
    <div class="col-lg-12 col-ml-12 padding-bottom-30">
        <div class="row">
            ...
            <div class="col-lg-6 mt-5">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title">{{__("Gig Quote Form Builder")}}</h4>
                        <form action="{{route('admin.form.builder.gig.quote')}}" method="Post">
                            @csrf
                            {!! render_drag_drop_form_builder_markup(get_static_option('apply_gig_single_page_quote_form_fields')) !!}
