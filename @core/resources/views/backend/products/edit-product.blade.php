                ...
                <div class="card">
                    <div class="card-body">
                        <div class="header-wrap">
                            ...
                            <a href="{{route('admin.products.all')}}" class="btn btn-primary btn-xs"><i class="fas fa-angle-double-left"></i>{{__('All Products')}}</a>
                        </div>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    @if(get_static_option('product_tax_type') == 'individual')
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"  name="tax_percentage" value="{{$product->tax_percentage}}">
                                        </div>
                                    @endif
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="meta_title"  class="form-control" value="{{$product->met_title}}" >
                                    </div>
                                    <div class="form-group">
