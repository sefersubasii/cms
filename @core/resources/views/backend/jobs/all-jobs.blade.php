                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                       ...
                                                       <br>
                                                        ...
                                                        <a class="btn btn-xs btn-primary mb-3 mr-1" href="{{route('admin.jobs.edit',$data->id)}}">
                                                            <i class="ti-pencil"></i>
                                                        </a>
                                                        <a class="btn btn-xs btn-light mb-3 mr-1" target="_blank" href="{{route('frontend.jobs.single',$data->slug)}}">
                                                            <i class="ti-eye"></i>
                                                        </a>
