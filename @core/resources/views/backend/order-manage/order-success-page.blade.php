                            ...
                            <div class="tab-content margin-top-30" id="nav-tabContent">
                                @foreach($all_languages as $key => $lang)
                                    <div class="tab-pane fade @if($key == 0) show active @endif" id="nav-home-{{$lang->slug}}" role="tabpanel" aria-labelledby="nav-home-tab">
                                        ...
                                        <div class="form-group">
                                            <label for="site_order_success_page_{{$lang->slug}}_subtitle">{{__('Subtitle')}}</label>
                                            <input type="text" name="site_order_success_page_{{$lang->slug}}_subtitle"  class="form-control" value="{{get_static_option('site_order_success_page_'.$lang->slug.'_subtitle')}}" id="site_order_success_page_{{$lang->slug}}_subtitle">
