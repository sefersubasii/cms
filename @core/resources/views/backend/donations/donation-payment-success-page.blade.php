                                ...
                                @foreach($all_languages as $key => $lang)
                                    <div class="tab-pane fade @if($key == 0) show active @endif" id="nav-home-{{$lang->slug}}" role="tabpanel" aria-labelledby="nav-home-tab">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="donation_success_page_{{$lang->slug}}_subtitle"  class="form-control" value="{{get_static_option('donation_success_page_'.$lang->slug.'_subtitle')}}" id="donation_success_page_{{$lang->slug}}_subtitle">
                                            <small class="info-text">{{__('{dnname} will be replaced by donation name')}}</small>
                                        </div>
                                        <div class="form-group">
