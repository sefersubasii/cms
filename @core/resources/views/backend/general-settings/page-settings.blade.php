                        ...
                        <form action="{{route('admin.general.page.settings')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="from-group">
                                        <label for="gig_page_slug">{{__('Gigs Page Slug')}}</label>
                                        <input type="text" class="form-control" value="{{get_static_option('gig_page_slug')}}" name="gig_page_slug" placeholder="{{__('Slug')}}" >
                                        <small>{{__('slug example: gigs')}}</small>
                                    </div>
                                    <div class="from-group">
                                            ...
                                            <div class="tab-pane fade @if($key == 0) show active @endif" id="nav-home-{{$lang->slug}}" role="tabpanel" aria-labelledby="nav-home-tab">
                                                <div class="accordion-wrapper">
                                                    <div id="accordion-{{$lang->slug}}">
                                                        ...
                                                        <div class="card">
                                                            <div class="card-header" id="gig_page_{{$lang->slug}}">
                                                                <h5 class="mb-0">
                                                                    <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#gig_page_content_{{$lang->slug}}" aria-expanded="false" >
                                                                        <span class="page-title">@if(!empty(get_static_option('gig_page_'.$lang->slug.'_name'))) {{get_static_option('gig_page_'.$lang->slug.'_name')}} @else {{__('Gigs')}}  @endif</span>
                                                                    </button>
                                                                </h5>
                                                            </div>
                                                            <div id="gig_page_content_{{$lang->slug}}" class="collapse"  data-parent="#accordion-{{$lang->slug}}">
                                                                <div class="card-body">
                                                                    <div class="from-group">
                                                                        <label for="gig_page_{{$lang->slug}}_name">{{__('Name')}}</label>
                                                                        <input type="text" class="form-control page-name" id="gig_page_{{$lang->slug}}_name" value="{{get_static_option('gig_page_'.$lang->slug.'_name')}}" name="gig_page_{{$lang->slug}}_name" placeholder="{{__('Name')}}" >
                                                                    </div>
                                                                    <div class="form-group margin-top-20">
                                                                        <label for="gig_page_{{$lang->slug}}_meta_tags">{{__('Meta Tags')}}</label>
                                                                        <input type="text" name="gig_page_{{$lang->slug}}_meta_tags"  class="form-control" data-role="tagsinput" value="{{get_static_option('gig_page_'.$lang->slug.'_meta_tags')}}" id="gig_page_{{$lang->slug}}_meta_tags">
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label for="gig_page_{{$lang->slug}}_meta_description">{{__('Meta Description')}}</label>
                                                                        <textarea name="gig_page_{{$lang->slug}}_meta_description"  class="form-control" rows="5" id="gig_page_{{$lang->slug}}_meta_description">{{get_static_option('gig_page_'.$lang->slug.'_meta_description')}}</textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
