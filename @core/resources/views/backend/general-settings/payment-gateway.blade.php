                                            ...
                                            <div class="card">
                                                ...
                                                <div id="midtrans_settings_content" class="collapse"  data-parent="#midtrans-payment">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="midtrans_environment">{{__('Midtranse Environment')}}</label>
                                                            <input type="text" name="midtrans_environment" id="midtrans_environment" value="{{get_static_option('midtrans_environment')}}" class="form-control">
                                                        </div>
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="payfast_settings_content" class="collapse"  data-parent="#payfast-payment">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="midtrans_environment">{{__('Payfast Merchant ENV')}}</label>
                                                            <input type="text" name="payfast_merchant_env" id="payfast_merchant_env" value="{{get_static_option('payfast_merchant_env')}}" class="form-control">
                                                        </div>
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="cashfree_settings_content" class="collapse"  data-parent="#cashfree-payment">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="cashfree_test_mode">{{__('Cashfree Test Mode')}}</label>
                                                            <input type="text" name="cashfree_test_mode" id="cashfree_test_mode" value="{{get_static_option('cashfree_test_mode')}}" class="form-control">
                                                        </div>
                                                        <div class="form-group">
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="instamojo_settings_content" class="collapse"  data-parent="#instamojo-payment">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="instamojo_test_mode">{{__('Instamojo Test Mode')}}</label>
                                                            <input type="text" name="instamojo_test_mode" id="instamojo_test_mode" value="{{get_static_option('instamojo_test_mode')}}" class="form-control">
                                                        </div>
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="marcado_pago_settings_content" class="collapse"  data-parent="#marcadopago-payment">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="marcadopago_test_mode"><strong>{{__('Enable Test Mode Instamojo')}}</strong></label>
                                                            <label class="switch">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="marcadopago_preview_logo"><strong>{{__('Marcado Pago_gateway Logo')}}</strong></label>
                                                            <div class="media-upload-btn-wrapper">
                                                                <div class="img-wrap">
                                                                    @php
                                                        ...
                                                        <div class="form-group">
                                                            <label for="marcado_pago_test_mode">{{__('Marcado Pago Test Mode')}}</label>
                                                            <input type="text" name="marcado_pago_test_mode" id="marcado_pago_test_mode" value="{{get_static_option('marcado_pago_test_mode')}}" class="form-control">
                                                        </div>
