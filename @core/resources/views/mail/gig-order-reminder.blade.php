...
<div class="mail-container">
    ...
    <div class="inner-wrap">
        ...
        @else
            <p>{{__('Hello')}}</p>
        @endif
        <p>{{__('You have a pending order')}} #{{$data->id}} {{__('in')}} {{get_static_option('site_'.$default_lang.'_title')}}</p>
        <div class="btn-wrap">
            <a href="{{route('user.home')}}" class="anchor-btn">{{__('check your order')}}</a>
        </div>
    </div>
    <footer>
